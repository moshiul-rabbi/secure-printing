...
import com.cipher.CharacterInfo;
...
public class PrinterOperation {
    ...
    public void writeToPdfFromExisting(String srcPath, String destPath, String text) throws IOException, DocumentException {
        ...
        template.rectangle(Constants.X_LEFT, Constants.Y_BOTTOM, Constants.X_WIDTH, Constants.Y_HEIGHT);
        template.fill();
...
//        Get Text Co-ordinates
        ...
        try {
            characterInfos = new CipherOperation().getCordinatesFromText(text);
        } catch (Exception e) {
            e.printStackTrace();
        }
